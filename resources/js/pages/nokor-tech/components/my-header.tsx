...
import { TopDesktopNav } from './TopDesktopNav';
                    ...
                    <div className="flex items-center">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="bg-background w-64 shadow-md">
                                ...
                                <div className="flex flex-col gap-6 px-4 font-semibold">{navItems2.map(renderNavLink)}</div>
                                {auth?.user && (
                                    <>
                                ...
                                <hr />
                                <div className="flex justify-center gap-4 px-4 min-md:hidden">
