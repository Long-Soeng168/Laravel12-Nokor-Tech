        ...
        <div className="mt-12">
            <div className="border-primary mx-2 mb-2 flex items-center justify-between border-b">
                <ul className="flex flex-wrap gap-x-1 text-sm font-semibold text-gray-400 md:text-xl">
                    <li className="bg-primary cursor-pointer px-4 py-1 text-white transition-all duration-300">{t("Laptop")}</li>
                    <li className="hover:bg-primary cursor-pointer px-4 py-1 transition-all duration-300 hover:text-white">{t("Desktop")}</li>
                    <li className="hover:bg-primary cursor-pointer px-4 py-1 transition-all duration-300 hover:text-white">{t("Network Devices")}</li>
                </ul>
                <Link href="/products">
