        ...
        <NokorTechLayout>
            <div className="mx-auto max-w-screen-xl px-6 py-16 pt-6 xl:px-0">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <h2 className="text-3xl font-bold tracking-tight">{t("Blog Posts")}</h2>
                                ...
                                <CardContent className="flex h-full flex-col items-start justify-between pb-6">
                                    <div>
                                        <div className="flex items-center gap-3">
                                            <Badge className="bg-primary/5 text-primary hover:bg-primary/5 shadow-none">{currentLocale === "kh"? item?.category?.name_kh: item?.category?.name}</Badge>
                                        ...
                                        <h3 className="mt-4 line-clamp-2 text-[1.35rem] font-semibold tracking-tight">{currentLocale === "kh"? item?.title_kh : item?.title}</h3>
                                        <p className="text-muted-foreground mt-2 line-clamp-3">{currentLocale === "kh"? item?.short_description_kh : item?.short_description}</p>
                                    </div>
